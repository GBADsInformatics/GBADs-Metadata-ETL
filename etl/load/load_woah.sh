...
DataDownload=${DATADIR}/${DATE}_${TABLENAME}_DataDownload.json
echo "Loading and connecting DataDownload nodes to dataset node from ${DataDownload}"
python3 load_data.py -p ${DataDownload} -f json -t DataDownload -n ${TABLENAME}